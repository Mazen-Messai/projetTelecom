function [TEB_bpsk_sans_canal] = bpsk_multitrajet_bruit_sans_canal(Fe, Rb)
    ...
    % Paramètres
    N = 10;               % Nombre de bits    symbols = 2*bits - 1;
    ...
    TEB_bpsk_sans_canal = [0 0 0 0 0 0 0 0];
    ...
    for indice_bruit=1:length(tab_Eb_N0_dB)
        ...
        while(nb_erreurs<100)
            ...
            hr = h;
            signal_recu_filtre_bpsk = filter(hr,1,signal_recu);
        ...
        %calcul du TEB
        TEB_bpsk_sans_canal(indice_bruit) = TEB / nb_cumul;
    end
end